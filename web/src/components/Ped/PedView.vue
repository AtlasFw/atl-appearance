...
<template>
  ...
  <div class="w-full bg-slate-800 mt-3 rounded flex flex-col justify-evenly items-center">
    ...
    <NSelect class="ml-2 mb-3 place-self-center mr-2.5 w-90%" @change="updateModel" v-model:value="$store.state.appearance.model" :consistent-menu-width="false" :options="$store.state.models"></NSelect>
  </div>
</template>